...
if (isset($_POST['areg_otp'])) {
    if ($otp == $aotp) {
        $sql = "INSERT INTO admin_data (AID,AFNAME,ALNAME,AEMAIL,APASSWORD,ASTATE) 
                VALUES ($aid,'$afname','$alname','$aemail','$apassword','$adistrict')";
        ...
        <div class="row justify-content-center align-items-center">
            <form name="myform" action="" method="POST" class="col-md-4 myform" style="margin: 30px 0px 0px 0px;">
                ...
                <div class="d-grid gap-2 inputs">
                    <input class="btn " type="submit" name="areg_otp" value="Register"
