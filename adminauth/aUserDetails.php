...
<body>
    ...
    if (isset($_SESSION['AID'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            <div class='card-header' style='background-color:#212529; color:white'>Bookstore User Details</div>
            <div class='card-body user-details-gradient'>
                <h5 class='card-title'>User Detail</h5>
                    ...
                    <h6 class='card-text'> Address1 : {$row['UADDRESS1']}</h6>
                    <h6 class='card-text'> Address2 : {$row['UADDRESS2']}</h6>
                    <h6 class='card-text'> Pincode : {$row['UPINCODE']}</h6>
                    <h6 class='card-text'> State : {$row['USTATE']}</h6>
                    <hr>
