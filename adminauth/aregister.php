...
if (isset($_POST['areg_submit'])) {
    ...
    if ($apassword === $aconfirm_password) {
        ...
        if (!mysqli_num_rows($result) > 0) {
            ...
            $_SESSION['astate'] = mysqli_escape_string($connection, $_POST['ASTATE']);
            ...
            <form name="myform" action="" method="POST" class="col-md-4 myform" style="margin: 30px 0px 0px 0px;"
                ...
                <div class="form-group row">
                    ...
                    <span class="input-group-text" style="width: 160px;">State</span>
                        <select class="form-select" id="inputGroupSelect01" style="width: 206px;" name="ASTATE" >
                            <option value="J&K" name="ASTATE">Jammu And Kashmir</option>
                            <option value="Goa" name="ASTATE">Goa</option>
                            <option value="Punjab" name="ASTATE">Punjab</option>
                            <option value="uttarakhand" name="ASTATE">Uttarakhand</option>
                            <option value="Uttar Pradesh" name="ASTATE">Uttar Prad"ASTATE">Himachal Pradesh</option>
                            <option value="Rajasthan" name="ASTATE">Rajasthan</option>
                            <option value="Madhyapradesh" name="ASTATE">Madhya pradesh</option>
                            <option value="Gujarat" name="ASTATE">Gujarat</option>
                            <option value="Jharkhand" name="ASTATE">Jharkhand</option>
                            <option value="Chattisgarh" name="ASTATE">Chattisgarh</option>
                            <option value="Chandigarh" name="ASTATE">Chandigarh</option>
                            <option value="Daman and Diu and Dadra Haveli" name="ASTATE">Daman and diu and dadra and nagar heveli</option>
                            <option value="Arunachal Pradesh" name="ASTATE">Arunachal Pradesh</option>
                            <option value="Sikkim" name="ASTATE">Sikkim</option>
                            <option value="WestBengal" name="ASTATE">West Bengal</option>
                            <option value="Bihar" name="ASTATE">Bihar</option>
                            <option value="Nagaland" name="ASTATE">Nagaland</option>
                            <option value="AndhraPradesh" name="ASTATE">Andhra Pradesh</option>
                            <option value="Karnataka" name="ASTATE">Karnataka</option>
                            <option value="TamilNadu" name="ASTATE">Tamil Nadu</option>
                        </select>
                    </div>
                </div>
                </div>
